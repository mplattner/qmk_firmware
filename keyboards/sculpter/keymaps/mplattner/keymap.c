...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
      ...
      OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), OSL(_ALTGR), KC_SPC, OSL(_ALTGR), KC_APP, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_ALTGR] = LAYOUT(
      ...
      KC_CAPS, RALT(KC_A), RALT(KC_S), KC_DEL, KC_F, RALT(KC_TAB), KC_H, KC_LEFT, KC_DOWN, KC_RIGHT, KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT, KC_INS, KC_PGUP,
...
bool procehhss_record_user(uint16_t keycode, keyrecord_t *record) {
