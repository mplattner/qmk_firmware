...
#define LAYOUT( \
  ...
  K09			, K0A, K1B, K2A, K29, K2E, K18, K28, K26, K25, K24, K14, K16,           K51, \
  K2B     , K3C, K4B, K3A, K39, K49, K48, K38, K36, K35, K34, K45, K54, K33, K17, K11, \
  K5D, K3B, K5C, K5B, K5A, K59, K69, K68		 , K58, K56, K55, K44, K52		 , K63, K53, \
  K6G			, K3E, K4F, K6A				   , K67          , K42, K43, K60     , K47, K64, K61 \
    ...
    { KC_NO, K31,   KC_NO, K33,   K34,   K35,   K36,   KC_NO, K38,   K39,   K3A,   K3B,   K3C,   KC_NO, K3E,   KC_NO, KC_NO, },   \
    { KC_NO, KC_NO, K42,   K43,   K44,   K45,   KC_NO, K47,   K48,   K49,   K4A,   K4B,   K4C,   KC_NO, KC_NO, K4F,   KC_NO, },   \
    { KC_NO, K51,   K52,   K53,   K54,   K55,   K56,   KC_NO, K58,   K59,   K5A,   K5B,   K5C,   K5D,   KC_NO, KC_NO, KC_NO, },   \
...
// k54=nuhs (# next to enter)
// k3b=nubs (left backslash next to shift)